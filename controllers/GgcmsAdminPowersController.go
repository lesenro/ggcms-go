...
// @Title Post
// @Description create GgcmsAdminPowers
// @Param	body		body 	models.GgcmsAdminPowers	true		"body for GgcmsAdminPowers content"
// @Success 201 {int} models.GgcmsAdminPowers
// @Failure 403 body is empty
// @router /add [post]
func (c *GgcmsAdminPowersController) Add() {
	var v models.GgcmsAdminPowers
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		if msg.Code == 0 {
			...
			exist := models.ExistGgcmsAdminPowers(query)
			if exist {
				msg.Code = 101
				msg.Msg = "已存在，不能重复添加。"
			} else {
				if _, err := models.AddGgcmsAdminPowers(&v); err == nil {
	...
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &v); err == nil {
		...
		if msg.Code == 0 {
			...
			if exist {
				...
				if err := models.UpdateGgcmsAdminPowersById(&v); err == nil {
					c.Ctx.Output.SetStatus(201)
					msg = models.Message{0, "成功", v}
					c.Data["json"] = msg
				} else {
...
func (this *GgcmsAdminPowersController) validation(v models.GgcmsAdminPowers) (msg models.Message) {
	msg = models.Message{0, "", nil}
	return
}

// @Title Get
// @Description get GgcmsAdminPowers by id
// @Param	id		path 	string	true		"The key for staticblock"
// @Success 200 {object} models.GgcmsAdminPowers
// @Failure 403 :id is empty
// @router /:id [get]
func (c *GgcmsAdminPowersController) GetOne() {
	idStr := c.Ctx.Input.Param(":id")
	id, _ := strconv.Atoi(idStr)
	v, err := GetOneGgcmsAdminPowers(id)
	if err != nil {
...
// @Title Get All
// @Description get GgcmsAdminPowers
...
// @Failure 403
// @router / [get]
func (c *GgcmsAdminPowersController) GetAll() {
	...
	l, _, err := GetAllGgcmsAdminPowers(strfields, strsortby, strorder, strquery, offset, limit, false)
	if err != nil {
		c.Data["json"] = err.Error()
	} else {
		c.Data["json"] = l
...
// @Title Delete
// @Description delete the GgcmsAdminPowers
// @Param	id		path 	string	true		"The id you want to delete"
// @Success 200 {string} delete success!
// @Failure 403 id is empty
// @router /delete [post]
func (c *GgcmsAdminPowersController) Delete() {
	msg := models.Message{1, "失败", nil}
	var ids []int
	if err := json.Unmarshal(c.Ctx.Input.RequestBody, &ids); err == nil {
		var num int64
		queryList, _ := getQueryList("")
		if num, err = models.MultDeleteGgcmsAdminPowers(queryList, ids); err == nil {
...
func GetOneGgcmsAdminPowers(id int) (v *models.GgcmsAdminPowers, err error) {
	v, err = models.GetGgcmsAdminPowersById(id)
	return
}
